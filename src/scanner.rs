			...
			_ => {
				if c.is_ascii_digit() {
					...
					let kind: TokenType = match i.readIdentifier().as_str() {
						"and" => i.reserved("and", "'and' operators in MoonSharp are made with '&&'"),
						"not" => i.reserved("not", "'not' operators in MoonSharp are made with '!'"),
						"or" => i.reserved("or", "'or' operators in MoonSharp are made with '||'"),
						"do" => i.reserved("do", "'do ... end' blocks in MoonSharp are made like this: '{ ... }'"),
						"end" => i.reserved("end", "code blocks in MoonSharp are closed with '}'"),
						"repeat" => i.reserved("repeat", "'repeat ... until x' loops in MoonSharp are made like this: 'loop { ... } until x'"),
						"then" => i.reserved("then", "code blocks in MoonSharp are opened with '{'"),
						"if" => IF,
						"elseif" => ELSEIF,
						"else" => ELSE,
						"for" => FOR,
						...
						"match" => MATCH,
						"default" => DEFAULT,
						"macro" => i.reserved("macro", "macros are defined using `#define` in MoonSharp!"),
